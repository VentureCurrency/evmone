...
struct EOFCodeType
{
    ...
    uint16_t stack_height_increase;  ///< Maximum stack height reached in the code above the inputs.

    EOFCodeType(uint8_t inputs_, uint8_t outputs_, uint16_t stack_height_increase_)
      : inputs{inputs_}, outputs{outputs_}, stack_height_increase{stack_height_increase_}
    {}
};
